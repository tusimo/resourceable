 ...
 * @template TModel of \Tusimo\Resource\Model\Model
 *
...
class Collection extends BaseCollection implements CompressInterface
{
     ...
     *
     * @param  array<array-key, (callable(\Tusimo\Resource\Model\Builder): mixed)|string>|string  $relations
     * @return $this
     */
     ...
     *
     * @param \Tusimo\Resource\Model\Collection $models
     */
