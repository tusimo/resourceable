 ...
 */
namespace Tusimo\Resource\Model\Relations\Concerns;
...
trait InteractsWithPivot
{
     ...
     *
     * @param array|\Hyperf\Utils\Collection|\Tusimo\Resource\Model\Model $ids
     * @return array
     */
    ...
    {
        return $this->query->getQuery()->newQuery();
    }
