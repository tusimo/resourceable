...
use Tusimo\Resource\Model\JsonEncodingException;
...
trait HasAttributes
{
    ...
    {
        return $this->dateFormat ?: DATE_W3C;
    }
    ...
    /**
     * Get attribute as DateTime string.
     *
     * @param mixed $name
     */
    public function getAsDateTime($name): string
    {
        return $this->fromDateTime($this->{$name});
    }

    /**
     * Check if the attributes has a target key.
     */
    ...
    /**
     * Check if the originals has a target key.
     */
