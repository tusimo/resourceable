...
abstract class Model implements \ArrayAccess, Arrayable, Jsonable, \JsonSerializable, CompressInterface
{
    ...
    use Concerns\HasCompress;
    use Concerns\HasBroadcastEvent;
    use Concerns\HasQueueEvent;
    ...
    /**
     * Resource Repository using.
     *
     * @var ResourceRepositoryContract
     */
    protected ?ResourceRepositoryContract $repository = null;
    ...
    public function __sleep()
    {
        ...
        return array_diff(array_keys(get_object_vars($this)), ['validator', 'repository']);
    }
     ...
     *
     * @return $this
     * @throws \Tusimo\Resource\Model\MassAssignmentException
     */
     ...
     *
     * @param \Tusimo\Resource\Model\Model $parent
     * @param string $table
     * @param bool $exists
     * @param null|string $using
     * @return \Tusimo\Resource\Model\Relations\Pivot
     */
    public function newPivot(self $parent, array $attributes, $table, $exists, $using = null)
    {
        return $using::fromRawAttributes($parent, $attributes, $table, $exists);
    }
     ...
     * @param int $options
     * @return string
     * @throws \Tusimo\Resource\Model\JsonEncodingException
     */
    ...
    public function replicate(array $except = null)
    {
        ...
        return tap(new static(), function ($instance) use ($attributes) {
            // @var \Tusimo\Resource\Model\Model $instance
    ...
    /**
     * Clone the model with all attributes.
     *
     * @return static
     */
    ...
    /**
     * Replicate current model to N number in a collection.
     *
     * @return Collection
     */
    public function replicateToN(int $number, array $except = [])
    {
        $models = [];
        while ($number > 0) {
            $models[] = $this->replicate($except);
            --$number;
        }
     ...
     *
     * @param null|\Tusimo\Resource\Model\Model $model
     * @return bool
     */
    public function is($model)
    {
        return ! is_null($model) && $this->getKey() === $model->getKey();
    }
    ...
    public function getRepository(): ResourceRepositoryContract
    {
        if (is_null($this->repository)) {
            ...
            if (env('APP_ENV') == 'testing') {
                if ($this->repository instanceof ShouldMockContract) {
                    $this->repository = $this->collectionRepository();
    ...
    /**
     * Set resource Repository using.
     *
     * @param ResourceRepositoryContract $repository Resource Repository using
     *
     * @return self
     */
     ...
     *
     * @param \Tusimo\Resource\Model\Builder $query
     * @return bool
     */
    ...
    abstract protected function repository(): ResourceRepositoryContract;
}
